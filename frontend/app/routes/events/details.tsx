...
import { LineItemsTable, type LineItem } from '~/components/events/line-items-table';
import dayjs from 'dayjs';
import { EventsTimeline, type Event } from '~/components/events/events-timeline';
...
export const meta = () => [{ title: `Details | Orders | Dashboard | ${appConfig.site.name}` }];
